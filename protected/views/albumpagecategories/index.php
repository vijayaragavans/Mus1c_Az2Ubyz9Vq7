        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Music eStore
                        <small>Album Page Category</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Album Page Category</li>
                    </ol>
                </section>

                <!-- Main content -->
                <section class="content">
		  <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/albumpagecategories/create">Create</a>
		<div class="box">
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Album Page Category Id</th>
                                                <th>Album Page Category</th>
                                                <th>Album Page Category Is Active</th>
                                                <th>Created On</th>
                                            </tr>
                                        </thead>
                                        <tbody>
