        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Music eStore
                        <small>Manage Album Page Category</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Manage Album Page Category</li>
                    </ol>
                </section>
		...
		<div class="box">
                                <div class="box-body table-responsive">
                                            <?php $this->widget('zii.widgets.CDetailView', array(
                                                'data'=>$model,
                                                'attributes'=>array(
                                                    'album_page_category_id',
                                                    'album_page_category',
                                                    'album_page_category_is_active',
                                                    'album_page_category_created_on',
                                                ),
                                            )); ?>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
