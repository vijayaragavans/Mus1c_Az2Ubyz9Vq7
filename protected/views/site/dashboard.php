        ...
        <!--[if lt IE 9]>
          ...
          <script src="https://oss.maxcdn.com/libs/respond.<?php echo Yii::app()->request->baseUrl; ?>/files/js/1.3.0/respond.min.js"></script>
        <![endif]-->
    <div class="skin-blue">
        <!-- header logo: style can be found in header.less -->
        <header class="header">
            <a href="dashboard.html" class="logo" style="height: 65px;">
            ...
            <?php echo $this->renderPartial('top_header'); ?>
            <!--   Include Top header Menus Ends-->
        </header>
        <div class="wrapper row-offcanvas row-offcanvas-left">

            <!--   Include Left side MenuBar Starts-->
            <?php echo $this->renderPartial('sidebar_menu'); ?>
                        ...
                        <section class="col-lg-6 connectedSortable">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body chat" id="chat-box">
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/files/img/avatar.png" alt="user image" class="online"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/files/img/avatar2.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/files/img/avatar3.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
